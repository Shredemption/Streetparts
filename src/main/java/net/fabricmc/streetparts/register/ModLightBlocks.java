...
public class ModLightBlocks {
    public static final PostBlock BLACK_LIGHT_POST = registerPostBlock("black_light_post",
            new PostBlock(AbstractBlock.Settings.copy(Blocks.IRON_BLOCK).strength(5f).requiresTool()));
    public static final ArmBlock BLACK_LIGHT_ARM = registerArmBlock("black_light_arm",
            new ArmBlock(AbstractBlock.Settings.copy(Blocks.IRON_BLOCK).strength(5f).requiresTool()));
    public static final CornerBlock BLACK_LIGHT_CORNER = registerCornerBlock("black_light_corner",
            new CornerBlock(AbstractBlock.Settings.copy(Blocks.IRON_BLOCK).strength(5f).requiresTool()));
    public static final LCornerBlock BLACK_LIGHT_L_CORNER = registerLCornerBlock("black_light_l_corner",
            new LCornerBlock(AbstractBlock.Settings.copy(Blocks.IRON_BLOCK).strength(5f).requiresTool()));
    public static final TBlock BLACK_LIGHT_T = registerTBlock("black_light_t",
            new TBlock(AbstractBlock.Settings.copy(Blocks.IRON_BLOCK).strength(5f).requiresTool()));
    public static final LightBlock BLACK_LIGHT_LIGHT = registerLightBlock("black_light_light",
            new LightBlock(AbstractBlock.Settings.copy(Blocks.IRON_BLOCK).strength(5f).requiresTool().luminance(value -> 15)));
